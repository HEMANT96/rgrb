  ...
  <div class="wrapper" :class="{ 'nav-open': $sidebar.showSidebar }">
    ...
    >
      <template slot-scope="props" slot="links">
        ...
        <sidebar-item
          :link="{ name: 'Restaurants', icon: 'fa fa-coffee',  path: '/restaurants' }"
        >  </sidebar-item>


        <sidebar-item
          :link="{ name: 'Listings', icon: 'fa fa-list-alt' }"
        >
          <sidebar-item
            :link="{ name: 'Categories', path: '/categories' }"
          ></sidebar-item>
          <sidebar-item
            :link="{ name: 'Menus', path: '/menus' }"
          ></sidebar-item>
        </sidebar-item>

      <sidebar-item
          :link="{ name: 'Orders', icon: 'fa fa-shopping-cart',  path: '/orders' }"
        >  </sidebar-item>
         <sidebar-item
          :link="{ name: 'PromoCode', icon: 'fa fa-list-alt',  path: '/promocode' }"
        >  </sidebar-item>
